...
**Tasks**:
- [ ] Verify `kicad-cli sch erc` works on sample schematics
- [ ] Document ERC JSON output format
- [ ] Create sample .kicad_sch test files (simple, hierarchical, with errors)
- [ ] Identify all ERC error types in output

**Success Criteria**:
- [ ] ERC JSON output parsed and understood
- [ ] Test schematics with known violations produce expected errors
- [ ] Hierarchical schematic ERC works
...
- [ ] **Phase 1**: Native ERC verified, test files created
